...
```sh
export ORCA_SESS_EXECUTABLE="$PWD/resources/magi/sess"
export ORCA_SESS_DIR="$PWD/.magi-sess"
pnpm dev
```
...
resources/magi/sess is from DeepakSilaych/sess at 7b0e8437e6e7e93f1bba787d728f0f4a7d9c071e, with its MIT license beside it. The Magi status-bar option is retained. This fork adds SESS_ATTACH_ONLY=1, which refuses absent sessions rather than recreating them during attachment.
